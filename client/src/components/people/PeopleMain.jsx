        ...
        <>
            <div className={peopleCSS.AppHeader}>
                <nav className={peopleCSS.panel} id="her">
                    <Link className={peopleCSS.nav_i+" panTea " + peopleCSS.panZvon} to="teachers" id={peopleCSS.nav_i} onClick={() => {setActivedMy(".panTea")}}>
                        Педагоги
                    </Link>
                    <Link className={peopleCSS.nav_i+" panHT " + peopleCSS.panPer} to="hteachers" id={peopleCSS.nav_i} onClick={() => {setActivedMy(".panHT")}}>
                        Завучи
                    </Link>
                    <Link className={peopleCSS.nav_i+" panCM " + peopleCSS.panPer} to="classmates" id={peopleCSS.nav_i} onClick={() => {setActivedMy(".panCM")}}>
                        Одноклассники
                    </Link>
                    <Link className={peopleCSS.nav_i+" panPar " + peopleCSS.panPer} to="parents" id={peopleCSS.nav_i} onClick={() => {setActivedMy(".panPar")}}>
                        Родители
                    </Link>
                    <Link className={peopleCSS.nav_i+" panAdm " + peopleCSS.panRas} to="admins" id={peopleCSS.nav_i} onClick={() => {setActivedMy(".panAdm")}}>
